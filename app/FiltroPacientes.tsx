...
export function FiltroPacientes({ initialSearch, currentLimit }: FiltroPacientesProps) {
  return (
    <form action="/" method="get" className="flex flex-col gap-2 sm:flex-row sm:items-center">
      ...
      <button
        type="submit"
        className="min-h-11 rounded-lg border border-primary bg-primary px-4 py-2 text-sm font-medium text-primary-foreground shadow-sm hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-primary/20"
      >
        Buscar
      </button>
    </form>
